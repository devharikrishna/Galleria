...
**Galleria** is a modern, premium Android gallery application built entirely with **Jetpack Compose**. It combines stunning aesthetics with powerful media management features, offering a fluid and highly customizable user experience.
...
*   **Smart Thumbnails**: Video frame decoding for rich previews.
